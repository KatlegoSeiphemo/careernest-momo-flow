...
const CVGenerator = () => {
  ...
  const generateCV = async () => {
    ...
    setTimeout(() => {
      const cv = `# ${formData.personalInfo.fullName}
...
I am excited to apply for opportunities in your organization. With my background in ${formData.skills || "relevant skills"} and experience in ${formData.experience || "work experience"}, I am confident I can contribute effectively. ${formData.summary || "Professional summary goes here."}
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Sparkles className="w-5 h-5 mr-2 text-primary" /> Enter Your Information
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
                  ...
                  {[
                    ...
                    <div key={id}>
                      ...
                      <Input
                        id={id}
                        type={type || "text"}
                        value={formData.personalInfo[id as keyof typeof formData.personalInfo]}
                        onChange={(e) => handleInputChange("personalInfo", id, e.target.value)}
                      />
                    </div>
                  ))}
                </div>
              ...
              {["summary", "experience", "education", "skills", "achievements", "coverLetter"].map((field) => (
                <div key={field}>
                  <Label htmlFor={field}>
                    {field === "coverLetter" ? "Cover Letter Notes" : field.charAt(0).toUpperCase() + field.slice(1)}
                  </Label>
                  <Textarea
                    id={field}
